...
func TestVBMeta(t *testing.T) {
	...
	tests := []struct {
		...
		{GET_VBMETA, "",
			gomemcached.SUCCESS,
			[]byte(`{"lastCas":0,"metaCas":0,"state":"dead","id":3}`),
			nil},
		{SET_VBMETA, "",
		...
		{GET_VBMETA, "",
			gomemcached.SUCCESS,
			[]byte(`{"lastCas":1,"metaCas":1,"state":"dead","id":3}`),
			&VBMeta{Id: 3, LastCas: 1, MetaCas: 1, State: "dead"}},
		{SET_VBMETA, `{"hi":"world"}`,
			gomemcached.SUCCESS, empty,
		...
		{GET_VBMETA, "",
			gomemcached.SUCCESS,
			[]byte(`{"lastCas":2,"metaCas":2,"state":"dead","id":3}`),
			&VBMeta{Id: 3, LastCas: 2, MetaCas: 2, State: "dead"}},
		{SET_VBMETA, `{}`,
			gomemcached.SUCCESS, empty,
			&VBMeta{Id: 3,
		...
		{GET_VBMETA, "",
			gomemcached.SUCCESS,
			[]byte(`{"lastCas":3,"metaCas":3,"state":"dead","id":3}`),
			&VBMeta{Id: 3,
				LastCas: 3,
				MetaCas: 3,
				State:   "dead"}},
		...
		{GET_VBMETA, "",
			gomemcached.SUCCESS,
			[]byte(`{"lastCas":4,"metaCas":4,"state":"dead","id":3}`),
			&VBMeta{Id: 3,
				LastCas: 4,
				MetaCas: 4,
				State:   "dead",
		...
		{GET_VBMETA, "",
			gomemcached.SUCCESS,
			[]byte(`{"lastCas":5,"metaCas":5,"state":"dead","id":3}`),
			&VBMeta{Id: 3,
				LastCas: 5,
				MetaCas: 5,
				State:   "dead"}},
		...
		{GET_VBMETA, "",
			gomemcached.SUCCESS,
			[]byte(`{"lastCas":100,"metaCas":6,"state":"dead","id":3}`),
			&VBMeta{Id: 3,
				LastCas: 100,
				MetaCas: 6,
				State:   "dead"}},
		...
		{GET_VBMETA, "",
			gomemcached.SUCCESS,
			[]byte(`{"lastCas":101,"metaCas":101,"state":"dead","id":3}`),
			&VBMeta{Id: 3,
				State:   "dead",
				LastCas: 101,
				MetaCas: 101}},
		...
		{GET_VBMETA, "",
			gomemcached.SUCCESS,
			[]byte(`{"lastCas":102,"metaCas":102,"state":"dead","id":3}`),
			&VBMeta{Id: 3,
				State:   "dead",
				LastCas: 102,
				MetaCas: 102,
